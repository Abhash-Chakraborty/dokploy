			...
			<PageHeader
				...
				actions={
					<InfoTooltip
						variant="warning"
						side="left"
						label="What raising this costs"
						content="Each concurrent build runs its own builder and image build, so raising this multiplies CPU, memory and disk use on the server. Set it to what the machine can actually handle: too high and builds exhaust memory and fail."
					/>
				}
			/>
