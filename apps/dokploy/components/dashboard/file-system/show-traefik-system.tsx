			...
			<PageHeader
				title={
					<span className="flex items-center gap-2">
						...
						<InfoTooltip
							variant="warning"
							content="Adding invalid configuration to existing files can break your Traefik instance, preventing access to your applications. Only advanced users should edit these files."
						/>
					</span>
				}
