...
function DropdownMenuLabel({
	...
	return (
		<DropdownMenuPrimitive.Label
			...
			data-inset={inset}
			className={cn(
				// Fork: render as a clearly non-interactive section header so it never
				// reads as a clickable action (it sits above the menu items).
				"px-1.5 py-1 text-xs font-medium uppercase tracking-wide text-muted-foreground data-inset:pl-7",
				className,
			)}
			{...props}
		/>
