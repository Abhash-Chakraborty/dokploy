...
export const slack = pgTable("slack", {
	slackId: text("slackId")
		...
		.primaryKey()
		.$defaultFn(() => nanoid()),
	webhookUrl: credentialText("webhookUrl").notNull(),
...
export const telegram = pgTable("telegram", {
	telegramId: text("telegramId")
		...
		.primaryKey()
		.$defaultFn(() => nanoid()),
	botToken: credentialText("botToken").notNull(),
...
export const gotify = pgTable("gotify", {
	...
	appToken: credentialText("appToken").notNull(),
...
export const ntfy = pgTable("ntfy", {
	...
	accessToken: credentialText("accessToken"),
